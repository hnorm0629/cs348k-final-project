...
RealType K32_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dz3+dphi_dz3)*(D1_6*(dnhat_dn2+dphi_dn2)+D1_1*(dnhat_dz2+dphi_dz2)+D1_5*nhat2*theta*2.0)+(dnhat_dn3+dphi_dn3)*(D1_6*(dnhat_dz2+dphi_dz2)+D6_6*(dnhat_dn2+dphi_dn2)+D5_6*nhat2*theta*2.0)+(nhat3+phi3)*(B1_5*(dnhat_dz2+dphi_dz2)+B5_6*(dnhat_dn2+dphi_dn2)+B5_5*nhat2*theta*2.0)+(a13+dubar_dz3)*(A1_1*(a12+dubar_dz2)+A1_6*(a22+dubar_dn2)+A1_5*(nhat2+phi2))+(a23+dubar_dn3)*(A1_6*(a12+dubar_dz2)+A6_6*(a22+dubar_dn2)+A5_6*(nhat2+phi2))+(dnhat_dz3+dphi_dz3)*(B1_1*(a12+dubar_dz2)+B1_6*(a22+dubar_dn2)+B1_5*(nhat2+phi2))+(dnhat_dn3+dphi_dn3)*(B1_6*(a12+dubar_dz2)+B6_6*(a22+dubar_dn2)+B5_6*(nhat2+phi2))+(nhat3+phi3)*(A1_5*(a12+dubar_dz2)+A5_6*(a22+dubar_dn2)+A5_5*(nhat2+phi2))+(a13+dubar_dz3)*(B1_6*(dnhat_dn2+dphi_dn2)+B1_1*(dnhat_dz2+dphi_dz2)+B1_5*nhat2*theta*2.0)+(a23+dubar_dn3)*(B1_6*(dnhat_dz2+dphi_dz2)+B6_6*(dnhat_dn2+dphi_dn2)+B5_6*nhat2*theta*2.0)+nhat3*theta*(B1_5*(a12+dubar_dz2)+B5_6*(a22+dubar_dn2)+B5_5*(nhat2+phi2))*2.0+nhat3*theta*(D1_5*(dnhat_dz2+dphi_dz2)+D5_6*(dnhat_dn2+dphi_dn2)+D5_5*nhat2*theta*2.0)*2.0;
