...
RealType F1_2(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a11+dubar_dz1)*(A1_1*eps_11_0+A1_2*eps_22_0+A1_3*eps_33_0+B1_1*eps_11_1+B1_2*eps_22_1+B1_3*eps_33_1+A1_6*gam_12_0+A1_5*gam_13_0+A1_4*gam_23_0+B1_6*gam_12_1+B1_5*gam_13_1+B1_4*gam_23_1)+(a21+dubar_dn1)*(A1_6*eps_11_0+A2_6*eps_22_0+A3_6*eps_33_0+B1_6*eps_11_1+B2_6*eps_22_1+B3_6*eps_33_1+A5_6*gam_13_0+A6_6*gam_12_0+A4_6*gam_23_0+B5_6*gam_13_1+B6_6*gam_12_1+B4_6*gam_23_1)+(dnhat_dz1+dphi_dz1)*(B1_1*eps_11_0+B1_2*eps_22_0+B1_3*eps_33_0+B1_6*gam_12_0+B1_5*gam_13_0+B1_4*gam_23_0+D1_1*eps_11_1+D1_2*eps_22_1+D1_3*eps_33_1+D1_6*gam_12_1+D1_5*gam_13_1+D1_4*gam_23_1)+(dnhat_dn1+dphi_dn1)*(B1_6*eps_11_0+B2_6*eps_22_0+B3_6*eps_33_0+B5_6*gam_13_0+B6_6*gam_12_0+B4_6*gam_23_0+D1_6*eps_11_1+D2_6*eps_22_1+D3_6*eps_33_1+D5_6*gam_13_1+D6_6*gam_12_1+D4_6*gam_23_1)+(nhat1+phi1)*(A1_5*eps_11_0+A2_5*eps_22_0+A3_5*eps_33_0+B1_5*eps_11_1+B2_5*eps_22_1+B3_5*eps_33_1+A5_6*gam_12_0+A5_5*gam_13_0+A4_5*gam_23_0+B5_6*gam_12_1+B5_5*gam_13_1+B4_5*gam_23_1)+nhat1*theta*(B1_5*eps_11_0+B2_5*eps_22_0+B3_5*eps_33_0+B5_6*gam_12_0+B5_5*gam_13_0+B4_5*gam_23_0+D1_5*eps_11_1+D2_5*eps_22_1+D3_5*eps_33_1+D5_6*gam_12_1+D5_5*gam_13_1+D4_5*gam_23_1)*2.0;
