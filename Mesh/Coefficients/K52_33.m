...
RealType K52_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(D2_2*(dnhat_dn2+dphi_dn2)+D2_6*(dnhat_dz2+dphi_dz2)+D2_4*nhat2*theta*2.0)+(a12+dubar_dz2)*(D2_6*(dnhat_dn2+dphi_dn2)+D6_6*(dnhat_dz2+dphi_dz2)+D4_6*nhat2*theta*2.0)+B1_2*eps_11_0+B2_2*eps_22_0+B2_3*eps_33_0+B2_6*gam_12_0+B2_5*gam_13_0+B2_4*gam_23_0+D1_2*eps_11_1+D2_2*eps_22_1+D2_3*eps_33_1+D2_6*gam_12_1+D2_5*gam_13_1+D2_4*gam_23_1+(nhat2+phi2)*(D2_4*(dnhat_dn2+dphi_dn2)+D4_6*(dnhat_dz2+dphi_dz2)+D4_4*nhat2*theta*2.0)+(a22+dubar_dn2)*(B2_2*(a22+dubar_dn2)+B2_6*(a12+dubar_dz2)+B2_4*(nhat2+phi2))+(a12+dubar_dz2)*(B2_6*(a22+dubar_dn2)+B6_6*(a12+dubar_dz2)+B4_6*(nhat2+phi2))+(nhat2+phi2)*(B2_4*(a22+dubar_dn2)+B4_6*(a12+dubar_dz2)+B4_4*(nhat2+phi2));
