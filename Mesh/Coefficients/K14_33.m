...
RealType K14_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = B1_2*eps_11_0+B2_2*eps_22_0+B2_3*eps_33_0+B2_6*gam_12_0+B2_5*gam_13_0+B2_4*gam_23_0+D1_2*eps_11_1+D2_2*eps_22_1+D2_3*eps_33_1+D2_6*gam_12_1+D2_5*gam_13_1+D2_4*gam_23_1+(a21+dubar_dn1)*(B2_2*(a21+dubar_dn1)+B2_6*(a11+dubar_dz1)+B2_4*(nhat1+phi1))+(a11+dubar_dz1)*(B2_6*(a21+dubar_dn1)+B6_6*(a11+dubar_dz1)+B4_6*(nhat1+phi1))+(dnhat_dn1+dphi_dn1)*(D2_2*(a21+dubar_dn1)+D2_6*(a11+dubar_dz1)+D2_4*(nhat1+phi1))+(dnhat_dz1+dphi_dz1)*(D2_6*(a21+dubar_dn1)+D6_6*(a11+dubar_dz1)+D4_6*(nhat1+phi1))+(nhat1+phi1)*(B2_4*(a21+dubar_dn1)+B4_6*(a11+dubar_dz1)+B4_4*(nhat1+phi1))+nhat1*theta*(D2_4*(a21+dubar_dn1)+D4_6*(a11+dubar_dz1)+D4_4*(nhat1+phi1))*2.0;
