...
RealType K55_21(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a12+dubar_dz2)*(D1_4*(dnhat_dn2+dphi_dn2)+D1_5*(dnhat_dz2+dphi_dz2)+D1_3*nhat2*theta*2.0)+(a22+dubar_dn2)*(D4_6*(dnhat_dn2+dphi_dn2)+D5_6*(dnhat_dz2+dphi_dz2)+D3_6*nhat2*theta*2.0)+B1_5*eps_11_0+B2_5*eps_22_0+B3_5*eps_33_0+B5_6*gam_12_0+B5_5*gam_13_0+B4_5*gam_23_0+D1_5*eps_11_1+D2_5*eps_22_1+D3_5*eps_33_1+D5_6*gam_12_1+D5_5*gam_13_1+D4_5*gam_23_1+(nhat2+phi2)*(D4_5*(dnhat_dn2+dphi_dn2)+D5_5*(dnhat_dz2+dphi_dz2)+D3_5*nhat2*theta*2.0)+(a12+dubar_dz2)*(B1_4*(a22+dubar_dn2)+B1_5*(a12+dubar_dz2)+B1_3*(nhat2+phi2))+(a22+dubar_dn2)*(B4_6*(a22+dubar_dn2)+B5_6*(a12+dubar_dz2)+B3_6*(nhat2+phi2))+(nhat2+phi2)*(B4_5*(a22+dubar_dn2)+B5_5*(a12+dubar_dz2)+B3_5*(nhat2+phi2));
