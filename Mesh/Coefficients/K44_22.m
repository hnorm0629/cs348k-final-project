...
RealType K44_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a11+dubar_dz1)*(D1_1*(a11+dubar_dz1)+D1_6*(a21+dubar_dn1)+D1_5*(nhat1+phi1))+(a21+dubar_dn1)*(D1_6*(a11+dubar_dz1)+D6_6*(a21+dubar_dn1)+D5_6*(nhat1+phi1))+(nhat1+phi1)*(D1_5*(a11+dubar_dz1)+D5_6*(a21+dubar_dn1)+D5_5*(nhat1+phi1));
