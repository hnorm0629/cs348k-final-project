...
RealType K66_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_2*(a23+dubar_dn3)+D2_6*(a13+dubar_dz3)+D2_4*(nhat3+phi3))+(a13+dubar_dz3)*(D2_6*(a23+dubar_dn3)+D6_6*(a13+dubar_dz3)+D4_6*(nhat3+phi3))+(nhat3+phi3)*(D2_4*(a23+dubar_dn3)+D4_6*(a13+dubar_dz3)+D4_4*(nhat3+phi3));
