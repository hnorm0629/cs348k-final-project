...
RealType K65_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a13+dubar_dz3)*(D1_1*(a12+dubar_dz2)+D1_6*(a22+dubar_dn2)+D1_5*(nhat2+phi2))+(a23+dubar_dn3)*(D1_6*(a12+dubar_dz2)+D6_6*(a22+dubar_dn2)+D5_6*(nhat2+phi2))+(nhat3+phi3)*(D1_5*(a12+dubar_dz2)+D5_6*(a22+dubar_dn2)+D5_5*(nhat2+phi2));
