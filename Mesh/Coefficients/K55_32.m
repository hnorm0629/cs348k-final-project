...
RealType K55_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(D1_2*(a12+dubar_dz2)+D2_6*(a22+dubar_dn2)+D2_5*(nhat2+phi2))+(a12+dubar_dz2)*(D1_6*(a12+dubar_dz2)+D6_6*(a22+dubar_dn2)+D5_6*(nhat2+phi2))+(nhat2+phi2)*(D1_4*(a12+dubar_dz2)+D4_6*(a22+dubar_dn2)+D4_5*(nhat2+phi2));
