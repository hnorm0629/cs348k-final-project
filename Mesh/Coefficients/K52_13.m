...
RealType K52_13(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn2+dphi_dn2)*(D2_4*(dnhat_dn2+dphi_dn2)+D4_6*(dnhat_dz2+dphi_dz2)+D4_4*nhat2*theta*2.0)+(dnhat_dz2+dphi_dz2)*(D2_5*(dnhat_dn2+dphi_dn2)+D5_6*(dnhat_dz2+dphi_dz2)+D4_5*nhat2*theta*2.0)+A1_4*eps_11_0+A2_4*eps_22_0+A3_4*eps_33_0+B1_4*eps_11_1+B2_4*eps_22_1+B3_4*eps_33_1+A4_6*gam_12_0+A4_5*gam_13_0+A4_4*gam_23_0+B4_6*gam_12_1+B4_5*gam_13_1+B4_4*gam_23_1+(nhat2+phi2)*(B2_3*(dnhat_dn2+dphi_dn2)+B3_6*(dnhat_dz2+dphi_dz2)+B3_4*nhat2*theta*2.0)+(a22+dubar_dn2)*(A2_4*(a22+dubar_dn2)+A4_6*(a12+dubar_dz2)+A4_4*(nhat2+phi2))+(a12+dubar_dz2)*(A2_5*(a22+dubar_dn2)+A5_6*(a12+dubar_dz2)+A4_5*(nhat2+phi2))+(dnhat_dn2+dphi_dn2)*(B2_4*(a22+dubar_dn2)+B4_6*(a12+dubar_dz2)+B4_4*(nhat2+phi2))+(dnhat_dz2+dphi_dz2)*(B2_5*(a22+dubar_dn2)+B5_6*(a12+dubar_dz2)+B4_5*(nhat2+phi2))+(nhat2+phi2)*(A2_3*(a22+dubar_dn2)+A3_6*(a12+dubar_dz2)+A3_4*(nhat2+phi2))+(a22+dubar_dn2)*(B2_4*(dnhat_dn2+dphi_dn2)+B4_6*(dnhat_dz2+dphi_dz2)+B4_4*nhat2*theta*2.0)+(a12+dubar_dz2)*(B2_5*(dnhat_dn2+dphi_dn2)+B5_6*(dnhat_dz2+dphi_dz2)+B4_5*nhat2*theta*2.0)+nhat2*theta*(B2_3*(a22+dubar_dn2)+B3_6*(a12+dubar_dz2)+B3_4*(nhat2+phi2))*2.0+nhat2*theta*(D2_3*(dnhat_dn2+dphi_dn2)+D3_6*(dnhat_dz2+dphi_dz2)+D3_4*nhat2*theta*2.0)*2.0;
