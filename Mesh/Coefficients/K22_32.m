...
RealType K22_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn2+dphi_dn2)*(D2_6*(dnhat_dn2+dphi_dn2)+D1_2*(dnhat_dz2+dphi_dz2)+D2_5*nhat2*theta*2.0)+(dnhat_dz2+dphi_dz2)*(D1_6*(dnhat_dz2+dphi_dz2)+D6_6*(dnhat_dn2+dphi_dn2)+D5_6*nhat2*theta*2.0)+A1_6*eps_11_0+A2_6*eps_22_0+A3_6*eps_33_0+B1_6*eps_11_1+B2_6*eps_22_1+B3_6*eps_33_1+A5_6*gam_13_0+A6_6*gam_12_0+A4_6*gam_23_0+B5_6*gam_13_1+B6_6*gam_12_1+B4_6*gam_23_1+(nhat2+phi2)*(B1_4*(dnhat_dz2+dphi_dz2)+B4_6*(dnhat_dn2+dphi_dn2)+B4_5*nhat2*theta*2.0)+(a22+dubar_dn2)*(A1_2*(a12+dubar_dz2)+A2_6*(a22+dubar_dn2)+A2_5*(nhat2+phi2))+(a12+dubar_dz2)*(A1_6*(a12+dubar_dz2)+A6_6*(a22+dubar_dn2)+A5_6*(nhat2+phi2))+(dnhat_dn2+dphi_dn2)*(B1_2*(a12+dubar_dz2)+B2_6*(a22+dubar_dn2)+B2_5*(nhat2+phi2))+(dnhat_dz2+dphi_dz2)*(B1_6*(a12+dubar_dz2)+B6_6*(a22+dubar_dn2)+B5_6*(nhat2+phi2))+(nhat2+phi2)*(A1_4*(a12+dubar_dz2)+A4_6*(a22+dubar_dn2)+A4_5*(nhat2+phi2))+(a22+dubar_dn2)*(B2_6*(dnhat_dn2+dphi_dn2)+B1_2*(dnhat_dz2+dphi_dz2)+B2_5*nhat2*theta*2.0)+(a12+dubar_dz2)*(B1_6*(dnhat_dz2+dphi_dz2)+B6_6*(dnhat_dn2+dphi_dn2)+B5_6*nhat2*theta*2.0)+nhat2*theta*(B1_4*(a12+dubar_dz2)+B4_6*(a22+dubar_dn2)+B4_5*(nhat2+phi2))*2.0+nhat2*theta*(D1_4*(dnhat_dz2+dphi_dz2)+D4_6*(dnhat_dn2+dphi_dn2)+D4_5*nhat2*theta*2.0)*2.0;
