...
RealType K42_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a21+dubar_dn1)*(D2_2*(dnhat_dn2+dphi_dn2)+D2_6*(dnhat_dz2+dphi_dz2)+D2_4*nhat2*theta*2.0)+(a11+dubar_dz1)*(D2_6*(dnhat_dn2+dphi_dn2)+D6_6*(dnhat_dz2+dphi_dz2)+D4_6*nhat2*theta*2.0)+(nhat1+phi1)*(D2_4*(dnhat_dn2+dphi_dn2)+D4_6*(dnhat_dz2+dphi_dz2)+D4_4*nhat2*theta*2.0)+(a21+dubar_dn1)*(B2_2*(a22+dubar_dn2)+B2_6*(a12+dubar_dz2)+B2_4*(nhat2+phi2))+(a11+dubar_dz1)*(B2_6*(a22+dubar_dn2)+B6_6*(a12+dubar_dz2)+B4_6*(nhat2+phi2))+(nhat1+phi1)*(B2_4*(a22+dubar_dn2)+B4_6*(a12+dubar_dz2)+B4_4*(nhat2+phi2));
