...
RealType K76_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (D4_4*(dnhat_dn3+dphi_dn3)+D4_5*(dnhat_dz3+dphi_dz3)+D3_4*nhat3*theta*2.0)*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+(D4_5*(dnhat_dn3+dphi_dn3)+D5_5*(dnhat_dz3+dphi_dz3)+D3_5*nhat3*theta*2.0)*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+(D3_4*(dnhat_dn3+dphi_dn3)+D3_5*(dnhat_dz3+dphi_dz3)+D3_3*nhat3*theta*2.0)*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0)+nhat3*(B1_3*eps_11_0+B2_3*eps_22_0+B3_3*eps_33_0+B3_6*gam_12_0+B3_5*gam_13_0+B3_4*gam_23_0+D1_3*eps_11_1+D2_3*eps_22_1+D3_3*eps_33_1+D3_6*gam_12_1+D3_5*gam_13_1+D3_4*gam_23_1)*2.0+(B4_4*(a23+dubar_dn3)+B4_5*(a13+dubar_dz3)+B3_4*(nhat3+phi3))*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+(B4_5*(a23+dubar_dn3)+B5_5*(a13+dubar_dz3)+B3_5*(nhat3+phi3))*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+(B3_4*(a23+dubar_dn3)+B3_5*(a13+dubar_dz3)+B3_3*(nhat3+phi3))*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0);
