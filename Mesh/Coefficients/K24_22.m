...
RealType K24_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a12+dubar_dz2)*(B1_1*(a11+dubar_dz1)+B1_6*(a21+dubar_dn1)+B1_5*(nhat1+phi1))+(a22+dubar_dn2)*(B1_6*(a11+dubar_dz1)+B6_6*(a21+dubar_dn1)+B5_6*(nhat1+phi1))+(dnhat_dz2+dphi_dz2)*(D1_1*(a11+dubar_dz1)+D1_6*(a21+dubar_dn1)+D1_5*(nhat1+phi1))+(dnhat_dn2+dphi_dn2)*(D1_6*(a11+dubar_dz1)+D6_6*(a21+dubar_dn1)+D5_6*(nhat1+phi1))+(nhat2+phi2)*(B1_5*(a11+dubar_dz1)+B5_6*(a21+dubar_dn1)+B5_5*(nhat1+phi1))+nhat2*theta*(D1_5*(a11+dubar_dz1)+D5_6*(a21+dubar_dn1)+D5_5*(nhat1+phi1))*2.0;
