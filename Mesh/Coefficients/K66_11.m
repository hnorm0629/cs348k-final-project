...
RealType K66_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn3+dphi_dn3)*(D4_4*(dnhat_dn3+dphi_dn3)+D4_5*(dnhat_dz3+dphi_dz3)+D3_4*nhat3*theta*2.0)+(dnhat_dz3+dphi_dz3)*(D4_5*(dnhat_dn3+dphi_dn3)+D5_5*(dnhat_dz3+dphi_dz3)+D3_5*nhat3*theta*2.0)+A1_3*eps_11_0+A2_3*eps_22_0+A3_3*eps_33_0+B1_3*eps_11_1+B2_3*eps_22_1+B3_3*eps_33_1+A3_6*gam_12_0+A3_5*gam_13_0+A3_4*gam_23_0+B3_6*gam_12_1+B3_5*gam_13_1+B3_4*gam_23_1+(nhat3+phi3)*(B3_4*(dnhat_dn3+dphi_dn3)+B3_5*(dnhat_dz3+dphi_dz3)+B3_3*nhat3*theta*2.0)+(a23+dubar_dn3)*(A4_4*(a23+dubar_dn3)+A4_5*(a13+dubar_dz3)+A3_4*(nhat3+phi3))+(a13+dubar_dz3)*(A4_5*(a23+dubar_dn3)+A5_5*(a13+dubar_dz3)+A3_5*(nhat3+phi3))+(dnhat_dn3+dphi_dn3)*(B4_4*(a23+dubar_dn3)+B4_5*(a13+dubar_dz3)+B3_4*(nhat3+phi3))+(dnhat_dz3+dphi_dz3)*(B4_5*(a23+dubar_dn3)+B5_5*(a13+dubar_dz3)+B3_5*(nhat3+phi3))+(nhat3+phi3)*(A3_4*(a23+dubar_dn3)+A3_5*(a13+dubar_dz3)+A3_3*(nhat3+phi3))+(a23+dubar_dn3)*(B4_4*(dnhat_dn3+dphi_dn3)+B4_5*(dnhat_dz3+dphi_dz3)+B3_4*nhat3*theta*2.0)+(a13+dubar_dz3)*(B4_5*(dnhat_dn3+dphi_dn3)+B5_5*(dnhat_dz3+dphi_dz3)+B3_5*nhat3*theta*2.0)+nhat3*theta*(B3_4*(a23+dubar_dn3)+B3_5*(a13+dubar_dz3)+B3_3*(nhat3+phi3))*2.0+nhat3*theta*(D3_4*(dnhat_dn3+dphi_dn3)+D3_5*(dnhat_dz3+dphi_dz3)+D3_3*nhat3*theta*2.0)*2.0;
