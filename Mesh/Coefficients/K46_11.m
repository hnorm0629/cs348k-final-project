...
RealType K46_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn1+dphi_dn1)*(D4_4*(dnhat_dn3+dphi_dn3)+D4_5*(dnhat_dz3+dphi_dz3)+D3_4*nhat3*theta*2.0)+(dnhat_dz1+dphi_dz1)*(D4_5*(dnhat_dn3+dphi_dn3)+D5_5*(dnhat_dz3+dphi_dz3)+D3_5*nhat3*theta*2.0)+(nhat1+phi1)*(B3_4*(dnhat_dn3+dphi_dn3)+B3_5*(dnhat_dz3+dphi_dz3)+B3_3*nhat3*theta*2.0)+(a21+dubar_dn1)*(A4_4*(a23+dubar_dn3)+A4_5*(a13+dubar_dz3)+A3_4*(nhat3+phi3))+(a11+dubar_dz1)*(A4_5*(a23+dubar_dn3)+A5_5*(a13+dubar_dz3)+A3_5*(nhat3+phi3))+(dnhat_dn1+dphi_dn1)*(B4_4*(a23+dubar_dn3)+B4_5*(a13+dubar_dz3)+B3_4*(nhat3+phi3))+(dnhat_dz1+dphi_dz1)*(B4_5*(a23+dubar_dn3)+B5_5*(a13+dubar_dz3)+B3_5*(nhat3+phi3))+(nhat1+phi1)*(A3_4*(a23+dubar_dn3)+A3_5*(a13+dubar_dz3)+A3_3*(nhat3+phi3))+(a21+dubar_dn1)*(B4_4*(dnhat_dn3+dphi_dn3)+B4_5*(dnhat_dz3+dphi_dz3)+B3_4*nhat3*theta*2.0)+(a11+dubar_dz1)*(B4_5*(dnhat_dn3+dphi_dn3)+B5_5*(dnhat_dz3+dphi_dz3)+B3_5*nhat3*theta*2.0)+nhat1*theta*(B3_4*(a23+dubar_dn3)+B3_5*(a13+dubar_dz3)+B3_3*(nhat3+phi3))*2.0+nhat1*theta*(D3_4*(dnhat_dn3+dphi_dn3)+D3_5*(dnhat_dz3+dphi_dz3)+D3_3*nhat3*theta*2.0)*2.0;
