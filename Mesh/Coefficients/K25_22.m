...
RealType K25_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = B1_1*eps_11_0+B1_2*eps_22_0+B1_3*eps_33_0+B1_6*gam_12_0+B1_5*gam_13_0+B1_4*gam_23_0+D1_1*eps_11_1+D1_2*eps_22_1+D1_3*eps_33_1+D1_6*gam_12_1+D1_5*gam_13_1+D1_4*gam_23_1+(a12+dubar_dz2)*(B1_1*(a12+dubar_dz2)+B1_6*(a22+dubar_dn2)+B1_5*(nhat2+phi2))+(a22+dubar_dn2)*(B1_6*(a12+dubar_dz2)+B6_6*(a22+dubar_dn2)+B5_6*(nhat2+phi2))+(dnhat_dz2+dphi_dz2)*(D1_1*(a12+dubar_dz2)+D1_6*(a22+dubar_dn2)+D1_5*(nhat2+phi2))+(dnhat_dn2+dphi_dn2)*(D1_6*(a12+dubar_dz2)+D6_6*(a22+dubar_dn2)+D5_6*(nhat2+phi2))+(nhat2+phi2)*(B1_5*(a12+dubar_dz2)+B5_6*(a22+dubar_dn2)+B5_5*(nhat2+phi2))+nhat2*theta*(D1_5*(a12+dubar_dz2)+D5_6*(a22+dubar_dn2)+D5_5*(nhat2+phi2))*2.0;
