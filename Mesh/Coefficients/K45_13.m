...
RealType K45_13(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a21+dubar_dn1)*(B2_4*(a22+dubar_dn2)+B4_6*(a12+dubar_dz2)+B4_4*(nhat2+phi2))+(a11+dubar_dz1)*(B2_5*(a22+dubar_dn2)+B5_6*(a12+dubar_dz2)+B4_5*(nhat2+phi2))+(dnhat_dn1+dphi_dn1)*(D2_4*(a22+dubar_dn2)+D4_6*(a12+dubar_dz2)+D4_4*(nhat2+phi2))+(dnhat_dz1+dphi_dz1)*(D2_5*(a22+dubar_dn2)+D5_6*(a12+dubar_dz2)+D4_5*(nhat2+phi2))+(nhat1+phi1)*(B2_3*(a22+dubar_dn2)+B3_6*(a12+dubar_dz2)+B3_4*(nhat2+phi2))+nhat1*theta*(D2_3*(a22+dubar_dn2)+D3_6*(a12+dubar_dz2)+D3_4*(nhat2+phi2))*2.0;
