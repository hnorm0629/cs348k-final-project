...
RealType K57_31(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(D2_4*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+D2_5*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+D2_3*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0))+(a12+dubar_dz2)*(D4_6*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+D5_6*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+D3_6*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0))+(nhat2+phi2)*(D4_4*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+D4_5*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+D3_4*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0));
