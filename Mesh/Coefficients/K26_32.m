...
RealType K26_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(B1_2*(a13+dubar_dz3)+B2_6*(a23+dubar_dn3)+B2_5*(nhat3+phi3))+(a12+dubar_dz2)*(B1_6*(a13+dubar_dz3)+B6_6*(a23+dubar_dn3)+B5_6*(nhat3+phi3))+(dnhat_dn2+dphi_dn2)*(D1_2*(a13+dubar_dz3)+D2_6*(a23+dubar_dn3)+D2_5*(nhat3+phi3))+(dnhat_dz2+dphi_dz2)*(D1_6*(a13+dubar_dz3)+D6_6*(a23+dubar_dn3)+D5_6*(nhat3+phi3))+(nhat2+phi2)*(B1_4*(a13+dubar_dz3)+B4_6*(a23+dubar_dn3)+B4_5*(nhat3+phi3))+nhat2*theta*(D1_4*(a13+dubar_dz3)+D4_6*(a23+dubar_dn3)+D4_5*(nhat3+phi3))*2.0;
