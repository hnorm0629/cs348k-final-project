...
RealType F1_3(RealType const* __nonnull A,
...
{
    RealType __attribute__((unused)) A1_1 = A[0];
    RealType A1_2 = A[1];
    RealType A1_3 = A[2];
    RealType A1_4 = A[3];
    RealType A1_5 = A[4];
    ...
    RealType   t0 = (a21+dubar_dn1)*(A1_2*eps_11_0+A2_2*eps_22_0+A2_3*eps_33_0+B1_2*eps_11_1+B2_2*eps_22_1+B2_3*eps_33_1+A2_6*gam_12_0+A2_5*gam_13_0+A2_4*gam_23_0+B2_6*gam_12_1+B2_5*gam_13_1+B2_4*gam_23_1)+(a11+dubar_dz1)*(A1_6*eps_11_0+A2_6*eps_22_0+A3_6*eps_33_0+B1_6*eps_11_1+B2_6*eps_22_1+B3_6*eps_33_1+A5_6*gam_13_0+A6_6*gam_12_0+A4_6*gam_23_0+B5_6*gam_13_1+B6_6*gam_12_1+B4_6*gam_23_1)+(dnhat_dn1+dphi_dn1)*(B1_2*eps_11_0+B2_2*eps_22_0+B2_3*eps_33_0+B2_6*gam_12_0+B2_5*gam_13_0+B2_4*gam_23_0+D1_2*eps_11_1+D2_2*eps_22_1+D2_3*eps_33_1+D2_6*gam_12_1+D2_5*gam_13_1+D2_4*gam_23_1)+(dnhat_dz1+dphi_dz1)*(B1_6*eps_11_0+B2_6*eps_22_0+B3_6*eps_33_0+B5_6*gam_13_0+B6_6*gam_12_0+B4_6*gam_23_0+D1_6*eps_11_1+D2_6*eps_22_1+D3_6*eps_33_1+D5_6*gam_13_1+D6_6*gam_12_1+D4_6*gam_23_1)+(nhat1+phi1)*(A1_4*eps_11_0+A2_4*eps_22_0+A3_4*eps_33_0+B1_4*eps_11_1+B2_4*eps_22_1+B3_4*eps_33_1+A4_6*gam_12_0+A4_5*gam_13_0+A4_4*gam_23_0+B4_6*gam_12_1+B4_5*gam_13_1+B4_4*gam_23_1)+nhat1*theta*(B1_4*eps_11_0+B2_4*eps_22_0+B3_4*eps_33_0+B4_6*gam_12_0+B4_5*gam_13_0+B4_4*gam_23_0+D1_4*eps_11_1+D2_4*eps_22_1+D3_4*eps_33_1+D4_6*gam_12_1+D4_5*gam_13_1+D4_4*gam_23_1)*2.0;
