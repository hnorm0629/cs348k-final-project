...
RealType K54_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn2+dphi_dn2)*(D4_4*(dnhat_dn1+dphi_dn1)+D4_5*(dnhat_dz1+dphi_dz1)+D3_4*nhat1*theta*2.0)+(dnhat_dz2+dphi_dz2)*(D4_5*(dnhat_dn1+dphi_dn1)+D5_5*(dnhat_dz1+dphi_dz1)+D3_5*nhat1*theta*2.0)+(nhat2+phi2)*(B3_4*(dnhat_dn1+dphi_dn1)+B3_5*(dnhat_dz1+dphi_dz1)+B3_3*nhat1*theta*2.0)+(a22+dubar_dn2)*(A4_4*(a21+dubar_dn1)+A4_5*(a11+dubar_dz1)+A3_4*(nhat1+phi1))+(a12+dubar_dz2)*(A4_5*(a21+dubar_dn1)+A5_5*(a11+dubar_dz1)+A3_5*(nhat1+phi1))+(dnhat_dn2+dphi_dn2)*(B4_4*(a21+dubar_dn1)+B4_5*(a11+dubar_dz1)+B3_4*(nhat1+phi1))+(dnhat_dz2+dphi_dz2)*(B4_5*(a21+dubar_dn1)+B5_5*(a11+dubar_dz1)+B3_5*(nhat1+phi1))+(nhat2+phi2)*(A3_4*(a21+dubar_dn1)+A3_5*(a11+dubar_dz1)+A3_3*(nhat1+phi1))+(a22+dubar_dn2)*(B4_4*(dnhat_dn1+dphi_dn1)+B4_5*(dnhat_dz1+dphi_dz1)+B3_4*nhat1*theta*2.0)+(a12+dubar_dz2)*(B4_5*(dnhat_dn1+dphi_dn1)+B5_5*(dnhat_dz1+dphi_dz1)+B3_5*nhat1*theta*2.0)+nhat2*theta*(B3_4*(a21+dubar_dn1)+B3_5*(a11+dubar_dz1)+B3_3*(nhat1+phi1))*2.0+nhat2*theta*(D3_4*(dnhat_dn1+dphi_dn1)+D3_5*(dnhat_dz1+dphi_dz1)+D3_3*nhat1*theta*2.0)*2.0;
