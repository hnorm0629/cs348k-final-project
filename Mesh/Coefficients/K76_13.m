...
RealType K76_13(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (D2_4*(a23+dubar_dn3)+D4_6*(a13+dubar_dz3)+D4_4*(nhat3+phi3))*(a21*nhat1*2.0+a22*nhat2*2.0+a23*nhat3*2.0+dubar_dn1*nhat1*2.0+dubar_dn2*nhat2*2.0+dubar_dn3*nhat3*2.0)+(D2_5*(a23+dubar_dn3)+D5_6*(a13+dubar_dz3)+D4_5*(nhat3+phi3))*(a11*nhat1*2.0+a12*nhat2*2.0+a13*nhat3*2.0+dubar_dz1*nhat1*2.0+dubar_dz2*nhat2*2.0+dubar_dz3*nhat3*2.0)+(D2_3*(a23+dubar_dn3)+D3_6*(a13+dubar_dz3)+D3_4*(nhat3+phi3))*(nhat1*phi1*2.0+nhat2*phi2*2.0+nhat3*phi3*2.0+(nhat1*nhat1)*2.0+(nhat2*nhat2)*2.0+(nhat3*nhat3)*2.0);
