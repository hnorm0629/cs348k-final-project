...
RealType K64_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_2*(a21+dubar_dn1)+D2_6*(a11+dubar_dz1)+D2_4*(nhat1+phi1))+(a13+dubar_dz3)*(D2_6*(a21+dubar_dn1)+D6_6*(a11+dubar_dz1)+D4_6*(nhat1+phi1))+(nhat3+phi3)*(D2_4*(a21+dubar_dn1)+D4_6*(a11+dubar_dz1)+D4_4*(nhat1+phi1));
