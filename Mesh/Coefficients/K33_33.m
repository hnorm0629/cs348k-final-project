...
RealType K33_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn3+dphi_dn3)*(D2_2*(dnhat_dn3+dphi_dn3)+D2_6*(dnhat_dz3+dphi_dz3)+D2_4*nhat3*theta*2.0)+(dnhat_dz3+dphi_dz3)*(D2_6*(dnhat_dn3+dphi_dn3)+D6_6*(dnhat_dz3+dphi_dz3)+D4_6*nhat3*theta*2.0)+A1_2*eps_11_0+A2_2*eps_22_0+A2_3*eps_33_0+B1_2*eps_11_1+B2_2*eps_22_1+B2_3*eps_33_1+A2_6*gam_12_0+A2_5*gam_13_0+A2_4*gam_23_0+B2_6*gam_12_1+B2_5*gam_13_1+B2_4*gam_23_1+(nhat3+phi3)*(B2_4*(dnhat_dn3+dphi_dn3)+B4_6*(dnhat_dz3+dphi_dz3)+B4_4*nhat3*theta*2.0)+(a23+dubar_dn3)*(A2_2*(a23+dubar_dn3)+A2_6*(a13+dubar_dz3)+A2_4*(nhat3+phi3))+(a13+dubar_dz3)*(A2_6*(a23+dubar_dn3)+A6_6*(a13+dubar_dz3)+A4_6*(nhat3+phi3))+(dnhat_dn3+dphi_dn3)*(B2_2*(a23+dubar_dn3)+B2_6*(a13+dubar_dz3)+B2_4*(nhat3+phi3))+(dnhat_dz3+dphi_dz3)*(B2_6*(a23+dubar_dn3)+B6_6*(a13+dubar_dz3)+B4_6*(nhat3+phi3))+(nhat3+phi3)*(A2_4*(a23+dubar_dn3)+A4_6*(a13+dubar_dz3)+A4_4*(nhat3+phi3))+(a23+dubar_dn3)*(B2_2*(dnhat_dn3+dphi_dn3)+B2_6*(dnhat_dz3+dphi_dz3)+B2_4*nhat3*theta*2.0)+(a13+dubar_dz3)*(B2_6*(dnhat_dn3+dphi_dn3)+B6_6*(dnhat_dz3+dphi_dz3)+B4_6*nhat3*theta*2.0)+nhat3*theta*(B2_4*(a23+dubar_dn3)+B4_6*(a13+dubar_dz3)+B4_4*(nhat3+phi3))*2.0+nhat3*theta*(D2_4*(dnhat_dn3+dphi_dn3)+D4_6*(dnhat_dz3+dphi_dz3)+D4_4*nhat3*theta*2.0)*2.0;
