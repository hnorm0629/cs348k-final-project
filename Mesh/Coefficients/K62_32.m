...
RealType K62_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_6*(dnhat_dn2+dphi_dn2)+D1_2*(dnhat_dz2+dphi_dz2)+D2_5*nhat2*theta*2.0)+(a13+dubar_dz3)*(D1_6*(dnhat_dz2+dphi_dz2)+D6_6*(dnhat_dn2+dphi_dn2)+D5_6*nhat2*theta*2.0)+(nhat3+phi3)*(D1_4*(dnhat_dz2+dphi_dz2)+D4_6*(dnhat_dn2+dphi_dn2)+D4_5*nhat2*theta*2.0)+(a23+dubar_dn3)*(B1_2*(a12+dubar_dz2)+B2_6*(a22+dubar_dn2)+B2_5*(nhat2+phi2))+(a13+dubar_dz3)*(B1_6*(a12+dubar_dz2)+B6_6*(a22+dubar_dn2)+B5_6*(nhat2+phi2))+(nhat3+phi3)*(B1_4*(a12+dubar_dz2)+B4_6*(a22+dubar_dn2)+B4_5*(nhat2+phi2));
