...
RealType K45_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn1+dphi_dn1)*(D4_4*(dnhat_dn2+dphi_dn2)+D4_5*(dnhat_dz2+dphi_dz2)+D3_4*nhat2*theta*2.0)+(dnhat_dz1+dphi_dz1)*(D4_5*(dnhat_dn2+dphi_dn2)+D5_5*(dnhat_dz2+dphi_dz2)+D3_5*nhat2*theta*2.0)+(nhat1+phi1)*(B3_4*(dnhat_dn2+dphi_dn2)+B3_5*(dnhat_dz2+dphi_dz2)+B3_3*nhat2*theta*2.0)+(a21+dubar_dn1)*(A4_4*(a22+dubar_dn2)+A4_5*(a12+dubar_dz2)+A3_4*(nhat2+phi2))+(a11+dubar_dz1)*(A4_5*(a22+dubar_dn2)+A5_5*(a12+dubar_dz2)+A3_5*(nhat2+phi2))+(dnhat_dn1+dphi_dn1)*(B4_4*(a22+dubar_dn2)+B4_5*(a12+dubar_dz2)+B3_4*(nhat2+phi2))+(dnhat_dz1+dphi_dz1)*(B4_5*(a22+dubar_dn2)+B5_5*(a12+dubar_dz2)+B3_5*(nhat2+phi2))+(nhat1+phi1)*(A3_4*(a22+dubar_dn2)+A3_5*(a12+dubar_dz2)+A3_3*(nhat2+phi2))+(a21+dubar_dn1)*(B4_4*(dnhat_dn2+dphi_dn2)+B4_5*(dnhat_dz2+dphi_dz2)+B3_4*nhat2*theta*2.0)+(a11+dubar_dz1)*(B4_5*(dnhat_dn2+dphi_dn2)+B5_5*(dnhat_dz2+dphi_dz2)+B3_5*nhat2*theta*2.0)+nhat1*theta*(B3_4*(a22+dubar_dn2)+B3_5*(a12+dubar_dz2)+B3_3*(nhat2+phi2))*2.0+nhat1*theta*(D3_4*(dnhat_dn2+dphi_dn2)+D3_5*(dnhat_dz2+dphi_dz2)+D3_3*nhat2*theta*2.0)*2.0;
