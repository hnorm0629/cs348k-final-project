...
RealType K66_31(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_4*(dnhat_dn3+dphi_dn3)+D2_5*(dnhat_dz3+dphi_dz3)+D2_3*nhat3*theta*2.0)+(a13+dubar_dz3)*(D4_6*(dnhat_dn3+dphi_dn3)+D5_6*(dnhat_dz3+dphi_dz3)+D3_6*nhat3*theta*2.0)+B1_4*eps_11_0+B2_4*eps_22_0+B3_4*eps_33_0+B4_6*gam_12_0+B4_5*gam_13_0+B4_4*gam_23_0+D1_4*eps_11_1+D2_4*eps_22_1+D3_4*eps_33_1+D4_6*gam_12_1+D4_5*gam_13_1+D4_4*gam_23_1+(nhat3+phi3)*(D4_4*(dnhat_dn3+dphi_dn3)+D4_5*(dnhat_dz3+dphi_dz3)+D3_4*nhat3*theta*2.0)+(a23+dubar_dn3)*(B2_4*(a23+dubar_dn3)+B2_5*(a13+dubar_dz3)+B2_3*(nhat3+phi3))+(a13+dubar_dz3)*(B4_6*(a23+dubar_dn3)+B5_6*(a13+dubar_dz3)+B3_6*(nhat3+phi3))+(nhat3+phi3)*(B4_4*(a23+dubar_dn3)+B4_5*(a13+dubar_dz3)+B3_4*(nhat3+phi3));
