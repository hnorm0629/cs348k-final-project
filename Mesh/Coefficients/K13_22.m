...
RealType K13_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dz1+dphi_dz1)*(D1_6*(dnhat_dn3+dphi_dn3)+D1_1*(dnhat_dz3+dphi_dz3)+D1_5*nhat3*theta*2.0)+(dnhat_dn1+dphi_dn1)*(D1_6*(dnhat_dz3+dphi_dz3)+D6_6*(dnhat_dn3+dphi_dn3)+D5_6*nhat3*theta*2.0)+(nhat1+phi1)*(B1_5*(dnhat_dz3+dphi_dz3)+B5_6*(dnhat_dn3+dphi_dn3)+B5_5*nhat3*theta*2.0)+(a11+dubar_dz1)*(A1_1*(a13+dubar_dz3)+A1_6*(a23+dubar_dn3)+A1_5*(nhat3+phi3))+(a21+dubar_dn1)*(A1_6*(a13+dubar_dz3)+A6_6*(a23+dubar_dn3)+A5_6*(nhat3+phi3))+(dnhat_dz1+dphi_dz1)*(B1_1*(a13+dubar_dz3)+B1_6*(a23+dubar_dn3)+B1_5*(nhat3+phi3))+(dnhat_dn1+dphi_dn1)*(B1_6*(a13+dubar_dz3)+B6_6*(a23+dubar_dn3)+B5_6*(nhat3+phi3))+(nhat1+phi1)*(A1_5*(a13+dubar_dz3)+A5_6*(a23+dubar_dn3)+A5_5*(nhat3+phi3))+(a11+dubar_dz1)*(B1_6*(dnhat_dn3+dphi_dn3)+B1_1*(dnhat_dz3+dphi_dz3)+B1_5*nhat3*theta*2.0)+(a21+dubar_dn1)*(B1_6*(dnhat_dz3+dphi_dz3)+B6_6*(dnhat_dn3+dphi_dn3)+B5_6*nhat3*theta*2.0)+nhat1*theta*(B1_5*(a13+dubar_dz3)+B5_6*(a23+dubar_dn3)+B5_5*(nhat3+phi3))*2.0+nhat1*theta*(D1_5*(dnhat_dz3+dphi_dz3)+D5_6*(dnhat_dn3+dphi_dn3)+D5_5*nhat3*theta*2.0)*2.0;
