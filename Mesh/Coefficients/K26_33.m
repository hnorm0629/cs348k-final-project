...
RealType K26_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(B2_2*(a23+dubar_dn3)+B2_6*(a13+dubar_dz3)+B2_4*(nhat3+phi3))+(a12+dubar_dz2)*(B2_6*(a23+dubar_dn3)+B6_6*(a13+dubar_dz3)+B4_6*(nhat3+phi3))+(dnhat_dn2+dphi_dn2)*(D2_2*(a23+dubar_dn3)+D2_6*(a13+dubar_dz3)+D2_4*(nhat3+phi3))+(dnhat_dz2+dphi_dz2)*(D2_6*(a23+dubar_dn3)+D6_6*(a13+dubar_dz3)+D4_6*(nhat3+phi3))+(nhat2+phi2)*(B2_4*(a23+dubar_dn3)+B4_6*(a13+dubar_dz3)+B4_4*(nhat3+phi3))+nhat2*theta*(D2_4*(a23+dubar_dn3)+D4_6*(a13+dubar_dz3)+D4_4*(nhat3+phi3))*2.0;
