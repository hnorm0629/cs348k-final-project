...
RealType K41_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a11+dubar_dz1)*(D1_6*(dnhat_dn1+dphi_dn1)+D1_1*(dnhat_dz1+dphi_dz1)+D1_5*nhat1*theta*2.0)+(a21+dubar_dn1)*(D1_6*(dnhat_dz1+dphi_dz1)+D6_6*(dnhat_dn1+dphi_dn1)+D5_6*nhat1*theta*2.0)+B1_1*eps_11_0+B1_2*eps_22_0+B1_3*eps_33_0+B1_6*gam_12_0+B1_5*gam_13_0+B1_4*gam_23_0+D1_1*eps_11_1+D1_2*eps_22_1+D1_3*eps_33_1+D1_6*gam_12_1+D1_5*gam_13_1+D1_4*gam_23_1+(nhat1+phi1)*(D1_5*(dnhat_dz1+dphi_dz1)+D5_6*(dnhat_dn1+dphi_dn1)+D5_5*nhat1*theta*2.0)+(a11+dubar_dz1)*(B1_1*(a11+dubar_dz1)+B1_6*(a21+dubar_dn1)+B1_5*(nhat1+phi1))+(a21+dubar_dn1)*(B1_6*(a11+dubar_dz1)+B6_6*(a21+dubar_dn1)+B5_6*(nhat1+phi1))+(nhat1+phi1)*(B1_5*(a11+dubar_dz1)+B5_6*(a21+dubar_dn1)+B5_5*(nhat1+phi1));
