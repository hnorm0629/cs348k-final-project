...
RealType K41_12(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn1+dphi_dn1)*(D1_4*(dnhat_dz1+dphi_dz1)+D4_6*(dnhat_dn1+dphi_dn1)+D4_5*nhat1*theta*2.0)+(dnhat_dz1+dphi_dz1)*(D1_5*(dnhat_dz1+dphi_dz1)+D5_6*(dnhat_dn1+dphi_dn1)+D5_5*nhat1*theta*2.0)+A1_5*eps_11_0+A2_5*eps_22_0+A3_5*eps_33_0+B1_5*eps_11_1+B2_5*eps_22_1+B3_5*eps_33_1+A5_6*gam_12_0+A5_5*gam_13_0+A4_5*gam_23_0+B5_6*gam_12_1+B5_5*gam_13_1+B4_5*gam_23_1+(nhat1+phi1)*(B3_6*(dnhat_dn1+dphi_dn1)+B1_3*(dnhat_dz1+dphi_dz1)+B3_5*nhat1*theta*2.0)+(a21+dubar_dn1)*(A1_4*(a11+dubar_dz1)+A4_6*(a21+dubar_dn1)+A4_5*(nhat1+phi1))+(a11+dubar_dz1)*(A1_5*(a11+dubar_dz1)+A5_6*(a21+dubar_dn1)+A5_5*(nhat1+phi1))+(dnhat_dn1+dphi_dn1)*(B1_4*(a11+dubar_dz1)+B4_6*(a21+dubar_dn1)+B4_5*(nhat1+phi1))+(dnhat_dz1+dphi_dz1)*(B1_5*(a11+dubar_dz1)+B5_6*(a21+dubar_dn1)+B5_5*(nhat1+phi1))+(nhat1+phi1)*(A1_3*(a11+dubar_dz1)+A3_6*(a21+dubar_dn1)+A3_5*(nhat1+phi1))+(a21+dubar_dn1)*(B1_4*(dnhat_dz1+dphi_dz1)+B4_6*(dnhat_dn1+dphi_dn1)+B4_5*nhat1*theta*2.0)+(a11+dubar_dz1)*(B1_5*(dnhat_dz1+dphi_dz1)+B5_6*(dnhat_dn1+dphi_dn1)+B5_5*nhat1*theta*2.0)+nhat1*theta*(B1_3*(a11+dubar_dz1)+B3_6*(a21+dubar_dn1)+B3_5*(nhat1+phi1))*2.0+nhat1*theta*(D3_6*(dnhat_dn1+dphi_dn1)+D1_3*(dnhat_dz1+dphi_dz1)+D3_5*nhat1*theta*2.0)*2.0;
