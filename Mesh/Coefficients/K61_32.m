...
RealType K61_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_6*(dnhat_dn1+dphi_dn1)+D1_2*(dnhat_dz1+dphi_dz1)+D2_5*nhat1*theta*2.0)+(a13+dubar_dz3)*(D1_6*(dnhat_dz1+dphi_dz1)+D6_6*(dnhat_dn1+dphi_dn1)+D5_6*nhat1*theta*2.0)+(nhat3+phi3)*(D1_4*(dnhat_dz1+dphi_dz1)+D4_6*(dnhat_dn1+dphi_dn1)+D4_5*nhat1*theta*2.0)+(a23+dubar_dn3)*(B1_2*(a11+dubar_dz1)+B2_6*(a21+dubar_dn1)+B2_5*(nhat1+phi1))+(a13+dubar_dz3)*(B1_6*(a11+dubar_dz1)+B6_6*(a21+dubar_dn1)+B5_6*(nhat1+phi1))+(nhat3+phi3)*(B1_4*(a11+dubar_dz1)+B4_6*(a21+dubar_dn1)+B4_5*(nhat1+phi1));
