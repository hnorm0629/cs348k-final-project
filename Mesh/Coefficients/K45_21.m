...
RealType K45_21(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a11+dubar_dz1)*(D1_4*(dnhat_dn2+dphi_dn2)+D1_5*(dnhat_dz2+dphi_dz2)+D1_3*nhat2*theta*2.0)+(a21+dubar_dn1)*(D4_6*(dnhat_dn2+dphi_dn2)+D5_6*(dnhat_dz2+dphi_dz2)+D3_6*nhat2*theta*2.0)+(nhat1+phi1)*(D4_5*(dnhat_dn2+dphi_dn2)+D5_5*(dnhat_dz2+dphi_dz2)+D3_5*nhat2*theta*2.0)+(a11+dubar_dz1)*(B1_4*(a22+dubar_dn2)+B1_5*(a12+dubar_dz2)+B1_3*(nhat2+phi2))+(a21+dubar_dn1)*(B4_6*(a22+dubar_dn2)+B5_6*(a12+dubar_dz2)+B3_6*(nhat2+phi2))+(nhat1+phi1)*(B4_5*(a22+dubar_dn2)+B5_5*(a12+dubar_dz2)+B3_5*(nhat2+phi2));
