...
RealType K24_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(B2_2*(a21+dubar_dn1)+B2_6*(a11+dubar_dz1)+B2_4*(nhat1+phi1))+(a12+dubar_dz2)*(B2_6*(a21+dubar_dn1)+B6_6*(a11+dubar_dz1)+B4_6*(nhat1+phi1))+(dnhat_dn2+dphi_dn2)*(D2_2*(a21+dubar_dn1)+D2_6*(a11+dubar_dz1)+D2_4*(nhat1+phi1))+(dnhat_dz2+dphi_dz2)*(D2_6*(a21+dubar_dn1)+D6_6*(a11+dubar_dz1)+D4_6*(nhat1+phi1))+(nhat2+phi2)*(B2_4*(a21+dubar_dn1)+B4_6*(a11+dubar_dz1)+B4_4*(nhat1+phi1))+nhat2*theta*(D2_4*(a21+dubar_dn1)+D4_6*(a11+dubar_dz1)+D4_4*(nhat1+phi1))*2.0;
