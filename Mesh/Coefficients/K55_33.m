...
RealType K55_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a22+dubar_dn2)*(D2_2*(a22+dubar_dn2)+D2_6*(a12+dubar_dz2)+D2_4*(nhat2+phi2))+(a12+dubar_dz2)*(D2_6*(a22+dubar_dn2)+D6_6*(a12+dubar_dz2)+D4_6*(nhat2+phi2))+(nhat2+phi2)*(D2_4*(a22+dubar_dn2)+D4_6*(a12+dubar_dz2)+D4_4*(nhat2+phi2));
