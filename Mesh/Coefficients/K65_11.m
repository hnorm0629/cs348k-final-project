...
RealType K65_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn3+dphi_dn3)*(D4_4*(dnhat_dn2+dphi_dn2)+D4_5*(dnhat_dz2+dphi_dz2)+D3_4*nhat2*theta*2.0)+(dnhat_dz3+dphi_dz3)*(D4_5*(dnhat_dn2+dphi_dn2)+D5_5*(dnhat_dz2+dphi_dz2)+D3_5*nhat2*theta*2.0)+(nhat3+phi3)*(B3_4*(dnhat_dn2+dphi_dn2)+B3_5*(dnhat_dz2+dphi_dz2)+B3_3*nhat2*theta*2.0)+(a23+dubar_dn3)*(A4_4*(a22+dubar_dn2)+A4_5*(a12+dubar_dz2)+A3_4*(nhat2+phi2))+(a13+dubar_dz3)*(A4_5*(a22+dubar_dn2)+A5_5*(a12+dubar_dz2)+A3_5*(nhat2+phi2))+(dnhat_dn3+dphi_dn3)*(B4_4*(a22+dubar_dn2)+B4_5*(a12+dubar_dz2)+B3_4*(nhat2+phi2))+(dnhat_dz3+dphi_dz3)*(B4_5*(a22+dubar_dn2)+B5_5*(a12+dubar_dz2)+B3_5*(nhat2+phi2))+(nhat3+phi3)*(A3_4*(a22+dubar_dn2)+A3_5*(a12+dubar_dz2)+A3_3*(nhat2+phi2))+(a23+dubar_dn3)*(B4_4*(dnhat_dn2+dphi_dn2)+B4_5*(dnhat_dz2+dphi_dz2)+B3_4*nhat2*theta*2.0)+(a13+dubar_dz3)*(B4_5*(dnhat_dn2+dphi_dn2)+B5_5*(dnhat_dz2+dphi_dz2)+B3_5*nhat2*theta*2.0)+nhat3*theta*(B3_4*(a22+dubar_dn2)+B3_5*(a12+dubar_dz2)+B3_3*(nhat2+phi2))*2.0+nhat3*theta*(D3_4*(dnhat_dn2+dphi_dn2)+D3_5*(dnhat_dz2+dphi_dz2)+D3_3*nhat2*theta*2.0)*2.0;
