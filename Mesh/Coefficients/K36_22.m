...
RealType K36_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = B1_1*eps_11_0+B1_2*eps_22_0+B1_3*eps_33_0+B1_6*gam_12_0+B1_5*gam_13_0+B1_4*gam_23_0+D1_1*eps_11_1+D1_2*eps_22_1+D1_3*eps_33_1+D1_6*gam_12_1+D1_5*gam_13_1+D1_4*gam_23_1+(a13+dubar_dz3)*(B1_1*(a13+dubar_dz3)+B1_6*(a23+dubar_dn3)+B1_5*(nhat3+phi3))+(a23+dubar_dn3)*(B1_6*(a13+dubar_dz3)+B6_6*(a23+dubar_dn3)+B5_6*(nhat3+phi3))+(dnhat_dz3+dphi_dz3)*(D1_1*(a13+dubar_dz3)+D1_6*(a23+dubar_dn3)+D1_5*(nhat3+phi3))+(dnhat_dn3+dphi_dn3)*(D1_6*(a13+dubar_dz3)+D6_6*(a23+dubar_dn3)+D5_6*(nhat3+phi3))+(nhat3+phi3)*(B1_5*(a13+dubar_dz3)+B5_6*(a23+dubar_dn3)+B5_5*(nhat3+phi3))+nhat3*theta*(D1_5*(a13+dubar_dz3)+D5_6*(a23+dubar_dn3)+D5_5*(nhat3+phi3))*2.0;
