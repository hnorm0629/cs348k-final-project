...
RealType K34_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a13+dubar_dz3)*(B1_1*(a11+dubar_dz1)+B1_6*(a21+dubar_dn1)+B1_5*(nhat1+phi1))+(a23+dubar_dn3)*(B1_6*(a11+dubar_dz1)+B6_6*(a21+dubar_dn1)+B5_6*(nhat1+phi1))+(dnhat_dz3+dphi_dz3)*(D1_1*(a11+dubar_dz1)+D1_6*(a21+dubar_dn1)+D1_5*(nhat1+phi1))+(dnhat_dn3+dphi_dn3)*(D1_6*(a11+dubar_dz1)+D6_6*(a21+dubar_dn1)+D5_6*(nhat1+phi1))+(nhat3+phi3)*(B1_5*(a11+dubar_dz1)+B5_6*(a21+dubar_dn1)+B5_5*(nhat1+phi1))+nhat3*theta*(D1_5*(a11+dubar_dz1)+D5_6*(a21+dubar_dn1)+D5_5*(nhat1+phi1))*2.0;
