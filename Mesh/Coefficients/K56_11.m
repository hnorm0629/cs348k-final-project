...
RealType K56_11(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn2+dphi_dn2)*(D4_4*(dnhat_dn3+dphi_dn3)+D4_5*(dnhat_dz3+dphi_dz3)+D3_4*nhat3*theta*2.0)+(dnhat_dz2+dphi_dz2)*(D4_5*(dnhat_dn3+dphi_dn3)+D5_5*(dnhat_dz3+dphi_dz3)+D3_5*nhat3*theta*2.0)+(nhat2+phi2)*(B3_4*(dnhat_dn3+dphi_dn3)+B3_5*(dnhat_dz3+dphi_dz3)+B3_3*nhat3*theta*2.0)+(a22+dubar_dn2)*(A4_4*(a23+dubar_dn3)+A4_5*(a13+dubar_dz3)+A3_4*(nhat3+phi3))+(a12+dubar_dz2)*(A4_5*(a23+dubar_dn3)+A5_5*(a13+dubar_dz3)+A3_5*(nhat3+phi3))+(dnhat_dn2+dphi_dn2)*(B4_4*(a23+dubar_dn3)+B4_5*(a13+dubar_dz3)+B3_4*(nhat3+phi3))+(dnhat_dz2+dphi_dz2)*(B4_5*(a23+dubar_dn3)+B5_5*(a13+dubar_dz3)+B3_5*(nhat3+phi3))+(nhat2+phi2)*(A3_4*(a23+dubar_dn3)+A3_5*(a13+dubar_dz3)+A3_3*(nhat3+phi3))+(a22+dubar_dn2)*(B4_4*(dnhat_dn3+dphi_dn3)+B4_5*(dnhat_dz3+dphi_dz3)+B3_4*nhat3*theta*2.0)+(a12+dubar_dz2)*(B4_5*(dnhat_dn3+dphi_dn3)+B5_5*(dnhat_dz3+dphi_dz3)+B3_5*nhat3*theta*2.0)+nhat2*theta*(B3_4*(a23+dubar_dn3)+B3_5*(a13+dubar_dz3)+B3_3*(nhat3+phi3))*2.0+nhat2*theta*(D3_4*(dnhat_dn3+dphi_dn3)+D3_5*(dnhat_dz3+dphi_dz3)+D3_3*nhat3*theta*2.0)*2.0;
