...
RealType K61_33(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a23+dubar_dn3)*(D2_2*(dnhat_dn1+dphi_dn1)+D2_6*(dnhat_dz1+dphi_dz1)+D2_4*nhat1*theta*2.0)+(a13+dubar_dz3)*(D2_6*(dnhat_dn1+dphi_dn1)+D6_6*(dnhat_dz1+dphi_dz1)+D4_6*nhat1*theta*2.0)+(nhat3+phi3)*(D2_4*(dnhat_dn1+dphi_dn1)+D4_6*(dnhat_dz1+dphi_dz1)+D4_4*nhat1*theta*2.0)+(a23+dubar_dn3)*(B2_2*(a21+dubar_dn1)+B2_6*(a11+dubar_dz1)+B2_4*(nhat1+phi1))+(a13+dubar_dz3)*(B2_6*(a21+dubar_dn1)+B6_6*(a11+dubar_dz1)+B4_6*(nhat1+phi1))+(nhat3+phi3)*(B2_4*(a21+dubar_dn1)+B4_6*(a11+dubar_dz1)+B4_4*(nhat1+phi1));
