...
RealType K34_31(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (dnhat_dn3+dphi_dn3)*(D2_4*(dnhat_dn1+dphi_dn1)+D2_5*(dnhat_dz1+dphi_dz1)+D2_3*nhat1*theta*2.0)+(dnhat_dz3+dphi_dz3)*(D4_6*(dnhat_dn1+dphi_dn1)+D5_6*(dnhat_dz1+dphi_dz1)+D3_6*nhat1*theta*2.0)+(nhat3+phi3)*(B4_4*(dnhat_dn1+dphi_dn1)+B4_5*(dnhat_dz1+dphi_dz1)+B3_4*nhat1*theta*2.0)+(a23+dubar_dn3)*(A2_4*(a21+dubar_dn1)+A2_5*(a11+dubar_dz1)+A2_3*(nhat1+phi1))+(a13+dubar_dz3)*(A4_6*(a21+dubar_dn1)+A5_6*(a11+dubar_dz1)+A3_6*(nhat1+phi1))+(dnhat_dn3+dphi_dn3)*(B2_4*(a21+dubar_dn1)+B2_5*(a11+dubar_dz1)+B2_3*(nhat1+phi1))+(dnhat_dz3+dphi_dz3)*(B4_6*(a21+dubar_dn1)+B5_6*(a11+dubar_dz1)+B3_6*(nhat1+phi1))+(nhat3+phi3)*(A4_4*(a21+dubar_dn1)+A4_5*(a11+dubar_dz1)+A3_4*(nhat1+phi1))+(a23+dubar_dn3)*(B2_4*(dnhat_dn1+dphi_dn1)+B2_5*(dnhat_dz1+dphi_dz1)+B2_3*nhat1*theta*2.0)+(a13+dubar_dz3)*(B4_6*(dnhat_dn1+dphi_dn1)+B5_6*(dnhat_dz1+dphi_dz1)+B3_6*nhat1*theta*2.0)+nhat3*theta*(B4_4*(a21+dubar_dn1)+B4_5*(a11+dubar_dz1)+B3_4*(nhat1+phi1))*2.0+nhat3*theta*(D4_4*(dnhat_dn1+dphi_dn1)+D4_5*(dnhat_dz1+dphi_dz1)+D3_4*nhat1*theta*2.0)*2.0;
