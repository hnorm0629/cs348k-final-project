...
RealType K53_22(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a12+dubar_dz2)*(D1_6*(dnhat_dn3+dphi_dn3)+D1_1*(dnhat_dz3+dphi_dz3)+D1_5*nhat3*theta*2.0)+(a22+dubar_dn2)*(D1_6*(dnhat_dz3+dphi_dz3)+D6_6*(dnhat_dn3+dphi_dn3)+D5_6*nhat3*theta*2.0)+(nhat2+phi2)*(D1_5*(dnhat_dz3+dphi_dz3)+D5_6*(dnhat_dn3+dphi_dn3)+D5_5*nhat3*theta*2.0)+(a12+dubar_dz2)*(B1_1*(a13+dubar_dz3)+B1_6*(a23+dubar_dn3)+B1_5*(nhat3+phi3))+(a22+dubar_dn2)*(B1_6*(a13+dubar_dz3)+B6_6*(a23+dubar_dn3)+B5_6*(nhat3+phi3))+(nhat2+phi2)*(B1_5*(a13+dubar_dz3)+B5_6*(a23+dubar_dn3)+B5_5*(nhat3+phi3));
