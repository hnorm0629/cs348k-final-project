...
RealType K16_32(RealType const* __nonnull A,
		...
		RealType const* __nonnull dnhat1)
{
    ...
    RealType   t0 = (a21+dubar_dn1)*(B1_2*(a13+dubar_dz3)+B2_6*(a23+dubar_dn3)+B2_5*(nhat3+phi3))+(a11+dubar_dz1)*(B1_6*(a13+dubar_dz3)+B6_6*(a23+dubar_dn3)+B5_6*(nhat3+phi3))+(dnhat_dn1+dphi_dn1)*(D1_2*(a13+dubar_dz3)+D2_6*(a23+dubar_dn3)+D2_5*(nhat3+phi3))+(dnhat_dz1+dphi_dz1)*(D1_6*(a13+dubar_dz3)+D6_6*(a23+dubar_dn3)+D5_6*(nhat3+phi3))+(nhat1+phi1)*(B1_4*(a13+dubar_dz3)+B4_6*(a23+dubar_dn3)+B4_5*(nhat3+phi3))+nhat1*theta*(D1_4*(a13+dubar_dz3)+D4_6*(a23+dubar_dn3)+D4_5*(nhat3+phi3))*2.0;
